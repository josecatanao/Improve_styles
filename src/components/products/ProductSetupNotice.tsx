...
export function ProductSetupNotice() {
  return (
    <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6 text-amber-950">
      ...
      <h3 className="mt-2 text-lg font-semibold">A estrutura de produtos ainda nao existe no banco.</h3>
      <p className="mt-2 max-w-2xl text-sm text-amber-900/80">
        Rode o script SQL da ETAPA 3 no Supabase para habilitar cadastro, listagem, imagens e as regras de seguranca.
      </p>
      <div className="mt-4">
        <Link
