...
export default async function StoreSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="pt-2">
        <h2 className="text-lg font-semibold text-slate-900">Navegação e estrutura</h2>
        <p className="mt-1 mb-4 text-sm text-slate-500">Configure a navegação principal e a estrutura de páginas da loja.</p>
